    ...
    <div class="login-screen">
        ...
        <div class="login-form">
            ...
            <div class="control-group">
                <asp:TextBox ID="loginname" runat="server" class = "login-field" placeholder = "Username"></asp:TextBox><br/>
                <asp:Label ID="lloginname" runat="server" Text="" class="login-field-icon fui-user" for="loginname"></asp:Label>
            </div>

            <div class="control-group">
                <asp:TextBox ID="loginpass" runat="server" TextMode="Password" class = "login-field" placeholder = "Contraseña"></asp:TextBox><br/>
